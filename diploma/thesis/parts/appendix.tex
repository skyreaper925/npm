% !TeX root = ../thesis.tex
% ===================== ПРИЛОЖЕНИЕ =====================
\chapter*{Приложение А. Псевдокод алгоритма} % FIX: надо ли писать букву A? у нас же лишь одно приложение
...
моноширинного блока). % FIX: что это значит? в текст не добавлять
